...
--
-- Dumping data for table `country_Origin`
--

LOCK TABLES `country_Origin` WRITE;
/*!40000 ALTER TABLE `country_Origin` DISABLE KEYS */;
INSERT INTO `country_Origin` VALUES (1,'Brasileira'),(2,'Americana'),(3,'Francesa');
/*!40000 ALTER TABLE `country_Origin` ENABLE KEYS */;
UNLOCK TABLES;
