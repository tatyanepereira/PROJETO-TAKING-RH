...
CREATE TABLE candidato (
    ...
    FOREIGN KEY(candidatoDisability_id) REFERENCES candidatoDisability(candidatoDisability_id)
);
...
CREATE TABLE languages_skill (
    languagesskill_id INT NOT NULL AUTO_INCREMENT  PRIMARY KEY,
    language_id int,
	level_id int,
    candidato_id INT,
